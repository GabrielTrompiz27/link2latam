export const esTranslations = {
  ...
  'cookies.whatAre.description': 'Las cookies son pequeños archivos de texto que se almacenan en su dispositivo (computadora, teléfono inteligente u otro dispositivo electrónico) cuando visita un sitio web. Se utilizan ampliamente para hacer que los sitios web funcionen de manera más eficiente y proporcionar información a los propietarios del sitio web.',
  'cookies.types.title': 'Tipos de Cookies que Utilizamos',
  'cookies.types.essential.title': 'Cookies Esenciales',
  'cookies.types.essential.items': 'Estas cookies son necesarias para el funcionamiento básico de nuestro sitio web|Permiten funciones principales como seguridad, gestión de red y accesibilidad|No puede optar por no usar estas cookies ya que son esenciales para el funcionamiento del sitio',
  'cookies.browsers.title': 'Navegadores Web',
  'cookies.browsers.items': 'Chrome: Configuración -> Privacidad y seguridad -> Cookies y otros datos del sitio|Firefox: Opciones -> Privacidad y seguridad -> Cookies y datos del sitio|Safari: Preferencias -> Privacidad -> Cookies y datos del sitio web|Microsoft Edge: Configuración -> Cookies y permisos del sitio -> Cookies y datos del sitio',
  'cookies.thirdParty.title': 'Cookies de Terceros',
  'cookies.thirdParty.description': 'Podemos utilizar servicios de terceros que también colocan cookies en su dispositivo, incluyendo:',
  'cookies.thirdParty.items': 'Google Analytics|Redes publicitarias|Plataformas de redes sociales',
  'cookies.updates.title': 'Actualizaciones de esta Política',
  'cookies.updates.description': 'Podemos actualizar esta Política de Cookies de vez en cuando. Le notificaremos cualquier cambio publicando la nueva política en esta página.',
  'cookies.contact.title': 'Contáctenos',
  'cookies.contact.description': 'Si tiene alguna pregunta sobre nuestra Política de Cookies, contáctenos en: Email: info@link2latam.com',
  'cookies.lastUpdated': 'Última Actualización: Diciembre 2024',

  // Legal Dialog
  'legal.terms.title': 'Términos de Uso',
  'legal.terms.description': 'Al acceder y utilizar este sitio web (el "Sitio"), acepta los siguientes términos y condiciones:',
  'legal.sections.acceptance.title': '1. Aceptación de Términos',
  'legal.sections.acceptance.items': '1.1 El contenido de este Sitio es solo para su información general y uso. Está sujeto a cambios sin previo aviso.|1.2 Al usar este Sitio, acepta estos términos en su totalidad. Si no está de acuerdo con estos términos, no debe usar este Sitio.',
  ...
  'legal.sections.liability.items': '3.1 En ningún caso seremos responsables por cualquier pérdida o daño, incluyendo sin limitación, pérdida o daño indirecto o consecuente.|3.2 Se hace todo lo posible para mantener el Sitio funcionando sin problemas. Sin embargo, no asumimos responsabilidad por la indisponibilidad temporal.',
  'legal.contact.title': 'Información de Contacto',
  'legal.contact.description': 'Para cualquier pregunta o inquietud sobre este Aviso Legal, contáctenos en: Email: info@link2latam.com',
  'legal.lastUpdated': 'Última Actualización: Diciembre 2024',

  // Data Protection Dialog
  'dataProtection.intro.title': 'Introducción',
  'dataProtection.intro.description': 'Link2Latam está comprometido con la protección de sus datos personales y el respeto de su privacidad. Esta Declaración de Protección de Datos explica cómo recopilamos, utilizamos, almacenamos y protegemos su información personal.',
  ...
  'dataProtection.purpose.items': 'Prestación de nuestros servicios|Comunicación|Mejora de nuestros servicios|Cumplimiento legal',
  ...
  'dataProtection.contact.description': 'Para cualquier pregunta relacionada con la privacidad, contáctenos en: Email: info@link2latam.com',
